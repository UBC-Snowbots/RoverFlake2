...
def generate_launch_description():
    ...
    servo_yaml = load_yaml("dev_arm_moveit_config_v2", "config/rover_servo_params_dev_arm.yaml")
    ...
    ros2_controllers_path = os.path.join(
        get_package_share_directory("dev_arm_moveit_config_v2"),
        "config",
