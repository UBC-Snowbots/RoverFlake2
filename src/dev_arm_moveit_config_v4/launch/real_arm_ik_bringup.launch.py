...
Usage:
  ros2 launch dev_arm_moveit_config_v4 real_arm_ik_bringup.launch.py
"""
...
def generate_launch_description():
    ...
    moveit_config = (
        MoveItConfigsBuilder("dev_arm", package_name="dev_arm_moveit_config_v4")
    ...
    servo_yaml = load_yaml(
        "dev_arm_moveit_config_v4", "config/rover_servo_params_dev_arm.yaml"
    )
