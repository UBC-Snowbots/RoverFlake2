...
// Config is read once from the first feedback message that includes config
// data — the driver embeds config in every feedback message, but we only need
// to populate the table once.
