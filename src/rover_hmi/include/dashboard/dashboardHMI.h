  ...
  gnss_sub = create_subscription<sensor_msgs::msg::NavSatFix>(
    ...
    std::bind(&DashboardHMINode::gnssCallback, this, std::placeholders::_1)
        ...
        //   "/system/heartbeats", 10, std::bind(&DashboardHMINode::heartbeatCallback, this, std::placeholders::_1));
          ...
          rclcpp::Parameter onboard_jetson_subsystems_param;
            this->get_parameter("subsystems_onboard_jetson", onboard_jetson_subsystems_param);   
          //rclcpp::Parameter onboard_nuc_subsystems_param;
            // this->get_parameter("subsystems_onboard_nuc", onboard_nuc_subsystems_param); //TODO add for jetson
              ...
              monitored_system_names_onboard_jetson = onboard_jetson_subsystems_param.as_string_array();
...
heart_monitor& monitorLookUp(int computer);
  ...
  void gnssCallback(sensor_msgs::msg::NavSatFix::SharedPtr msg);
    ...
    heart_monitor onboard_jetson_heart_monitor;
