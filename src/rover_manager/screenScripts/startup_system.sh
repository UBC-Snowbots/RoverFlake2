...
i3-msg "workspace 1; exec kitty -e bash '$cb_scripts_PATH/left_screen_startup.bash'"
i3-msg "workspace 2; exec kitty -e bash '$cb_scripts_PATH/middle_screen_startup.sh'"
i3-msg "workspace 3; exec kitty -e bash '$cb_scripts_PATH/right_screen_startup.sh'"
