...
echo ${cb_REFRESH_RATE}

# source ${cb_scripts_PATH}/cb_env_variables.sh
xrandr --output $cb_MIDDLE_SCREEN_ID --mode $cb_MIDDLE_SCREEN_RES --rate $cb_REFRESH_RATE --primary --pos 1920x0 \
       --output $cb_LEFT_SCREEN_ID --mode $cb_LEFT_SCREEN_RES --rate $cb_REFRESH_RATE --pos 0x0 \
       --output $cb_RIGHT_SCREEN_ID --mode $cb_RIGHT_SCREEN_RES --rate $cb_REFRESH_RATE --pos 3840x0
