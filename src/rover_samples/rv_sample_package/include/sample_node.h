...
private:
    // Most member structures and functions are private in a custom ros2 node. - However, for ease of testing, you can make some functions public... or just everything public cus 
